...
router.post('/admin/settings', requireAdmin, (req, res) => {
    ...
    const allowedKeys = ['discord_announce_channel', 'discord_popdrop_channel', 'discord_incoming_channel', 'discord_battlereport_channel', 'discord_battlereport_alliance_tags', 'discord_new_player_channel', 'discord_blocked_channels', 'discord_battlepoints_channel', 'discord_variouschanges_channel', 'battle_points_cv_ratio', 'battle_points_pop_ratio', 'battle_points_excluded_alliance_tags', 'alliance_relations_allied', 'alliance_relations_war', 'system_plans_enabled'];
